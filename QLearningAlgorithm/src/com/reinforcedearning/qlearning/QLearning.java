...
public class QLearning {
	...
	private double[][] R = {
			...
			{Constants.STANDARD_REWARD,Constants.STANDARD_REWARD,Constants.STANDARD_REWARD,Constants.STANDARD_REWARD,Constants.MIN_VALUE,Constants.MIN_VALUE},
			{Constants.STANDARD_REWARD,Constants.MIN_VALUE,Constants.STANDARD_REWARD,Constants.MIN_VALUE,Constants.STANDARD_REWARD,Constants.MIN_VALUE},
